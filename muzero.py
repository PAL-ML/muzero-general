...
class MuZero:
    ...
    def train(self, log_in_tensorboard=True):
        ...
        self.shared_storage_worker.set_info.remote("trainer_can_start", False)
        ...
        wrappers.stonks.remote(self.checkpoint, self.Game, self.config, self.replay_buffer_worker, self.shared_storage_worker)
